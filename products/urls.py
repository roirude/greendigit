...
urlpatterns = [
    ...
    path("fm/<slug:slug>/categories/", views.FarmerSubCategoryListView.as_view(), name="farmer_sub_categories"),
    ...
    path("fm/<slug:fm_slug>/categories/<slug:slug>/", views.FarmerSubCategoryProductListView.as_view(), name="farmer_sub_category_detail"),
