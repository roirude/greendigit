...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=100, unique=True)
    description = models.TextField()
    sub_category = models.ForeignKey(SubCategory, on_delete=models.PROTECT, verbose_name='Category')
    quantity = models.IntegerField(verbose_name='Quantity (KG)')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Price (XAF/KG)')
